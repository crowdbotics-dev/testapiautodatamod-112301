...
## Project Structure
    ...
    ├── testapiautodatamod_112301  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_112301`
...
2. Clone this repo and `cd testapiautodatamod_112301`
